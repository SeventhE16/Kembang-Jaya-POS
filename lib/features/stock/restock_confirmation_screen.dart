...
class RestockConfirmationScreen extends StatefulWidget {
  ...
  @override
  State<RestockConfirmationScreen> createState() => _RestockConfirmationScreenState();
}

class _RestockConfirmationScreenState extends State<RestockConfirmationScreen> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          const Text('--- BUKTI RESTOCK ---', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          ...
          Row(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text('Staff : ${user?.displayName ?? 'Staff'}', style: const TextStyle(fontSize: 13, color: Colors.black)),
                  if (transaction?.supplierName != null)
                    Text('Supplier : ${transaction!.supplierName!}', style: const TextStyle(fontSize: 13, color: Colors.black)),
                ],
              ),
            ],
          ),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text('Total Pembelian', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black)),
          ...
          if (isCredit) ...[
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text('Tipe: hutang/kasbon', style: TextStyle(fontSize: 13, color: Colors.black)),
              ],
            ),
            const SizedBox(height: 4),
            const Text('STATUS: BELUM LUNAS', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Colors.black)),
            Text('SISA HUTANG: ${_currencyFormat.format(transaction?.debtAmount ?? 0)}', style: const TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Colors.black)),
            const SizedBox(height: 8),
            const _DashedDivider(),
            const SizedBox(height: 8),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Pembelian barang telah disimpan',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 15,
